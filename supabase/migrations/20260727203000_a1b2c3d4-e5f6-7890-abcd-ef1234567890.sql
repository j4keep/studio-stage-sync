-- YAJ Marketplace Phase 1 schema (classifieds / vehicles — separate from digital /store)
...
GRANT INSERT, UPDATE, DELETE ON public.marketplace_profiles, public.marketplace_listings, public.marketplace_listing_media, public.marketplace_vehicle_details, public.marketplace_saved_listings, public.marketplace_offers TO authenticated;
