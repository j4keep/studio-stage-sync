-- Allow the new pop_shot game type through the create_game RPC.
...
BEGIN
  ...
  IF p_game_type NOT IN ('tic_tac_toe', 'connect_four', 'dominoes', 'checkers', 'trivia', 'pool', 'boxing', 'battleship', 'driving', 'poker', 'pop_shot') THEN
