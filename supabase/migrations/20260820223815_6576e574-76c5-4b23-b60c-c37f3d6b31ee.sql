...
BEGIN
  ...
  IF p_game_type NOT IN ('tic_tac_toe', 'connect_four', 'dominoes', 'checkers', 'trivia', 'pool', 'boxing', 'battleship', 'driving', 'poker', 'pop_shot', 'knock_hockey', 'bingo', 'word_link', 'mini_golf', 'snake_royale', 'obby', 'city_run', 'treasure_rush', 'tower_escape') THEN
