...
GRANT ALL ON public.games, public.game_players, public.game_invites, public.game_moves, public.game_stats TO service_role;
...
BEGIN
  ...
  IF p_game_type NOT IN ('tic_tac_toe', 'connect_four', 'dominoes', 'checkers', 'trivia') THEN
