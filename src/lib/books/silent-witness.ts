...
/**
 * Silent Witness — finished YAJ original adult Mystery novella.
...
She unfolded it in the hallway, alone.

It was her. Drawn in the same short, economical strokes. And beneath the sketch, in small, careful lettering: TOMORROW.`,
  },
  {
    chapter: "Chapter 1 — The Gallery Sketch",
    text: `June brought the page to court security within the hour, and watched a deputy examine it with the particular, weary patience of a man who had spent a career being handed things people insisted were threatening and finding, nine times out of ten, that they were nothing at all.

“It’s a sketch,” he said. “With a word under it.”

“It’s a sketch of me, drawn by someone I’ve never spoken to, with tomorrow’s date implied under it, left where only someone tracking my exact movements could have left it,” June said, keeping her voice level with an effort that cost more than she wanted to admit. “I would like that treated as more than a compliment on my likeness.”

The deputy took a report, promised to review gallery seating logs for the day, and suggested — not unkindly, but not usefully either — that artists covering high-profile trials sometimes attracted overzealous fans. June had heard variations of this sentence before, about other cases, and had learned that overzealous fan was often the label attached retroactively to things that turned out, later, to have been considerably worse.
...
Tomorrow, the trial resumed. Tomorrow, the prosecution planned to introduce the fence sketches recovered from all three fire scenes as physical evidence.

June did not sleep well that night.`,
  },
  {
    chapter: "Chapter 1 — The Gallery Sketch",
...
The handwriting matched. Not Marsh’s — the prosecution’s own handwriting expert had already testified, two days earlier, that the fence captions did not conclusively match any sample provided by the defendant — but the lettering matched, precisely and unmistakably, the single word left beneath June’s own stolen portrait the previous afternoon.

She waited until the session broke for lunch before approaching the lead detective on the case, a tired, sharp-eyed woman named Priya Nasser who had testified twice already and clearly had very little patience left for anything outside her prepared script.

“I need five minutes,” June said. “About the fence captions.”

Nasser studied her for a moment, some professional instinct visibly recalibrating behind her eyes. “You have three,” she said. “Make them useful.”

June unfolded the stolen sketch and set it on the table between them, beside a photograph of the third fence caption pulled from the case file.

Nasser went very quiet, reading both, and June watched the detective’s exhaustion sharpen, in real time, into something considerably more alert.`,
  },
  {
...
“Longer than I’d like, given that he’s already escalated from posting online to leaving physical sketches on your equipment.” Nasser closed her laptop with more force than necessary. “I don’t want to wait for the subpoena to work through legal channels while he decides his next move is something other than a folded piece of paper.”

June thought about the word TOMORROW, and the trial’s own approaching verdict, and felt the shape of an idea beginning to form — reckless, uncomfortable, and increasingly, unavoidably necessary.

“Then let’s give him a tomorrow he can’t resist showing up for,” she said.`,
  },
  {
    chapter: "Chapter 2 — Old Case, New Fear",
...
If the third fire truly had been committed by someone other than Marsh — someone who had studied the first two crimes closely enough to imitate their signature but not closely enough, or carefully enough, to avoid leaving small, telling inconsistencies behind — then the man stalking June through sketches and forum posts might not simply be an obsessed fan drawn to a famous case.

He might be the actual author of the crime everyone had assumed belonged to someone else.

She raised the possibility to Nasser that evening, watching the detective’s expression sharpen into the particular stillness of someone confirming a suspicion she’d been quietly nursing for weeks.

“If that’s true,” Nasser said slowly, “then tomorrow’s unveiling isn’t just bait for a dangerous admirer. It’s our best chance at catching the person actually responsible for one-third of this case before the jury convicts the wrong man for all of it.”`,
  },
  {
    chapter: "Chapter 3 — Detective Nasser",
...
“It has to be,” Nasser said. “Closing arguments are in two days. If we don’t identify him tomorrow night, the jury convicts Marsh on evidence that includes a crime he very likely didn’t commit, and the actual arsonist walks free to decide, eventually, when he thinks the timing might finally suit him again.”`,
  },
  {
    chapter: "Chapter 4 — The Decoy",
    text: `The gallery filled slowly on the evening of the unveiling, drawn by Roland Vance’s carefully worded press release promising the definitive courtroom sketch of the Framer trial, a modest crowd of reporters, true-crime enthusiasts, and ordinary curious locals who had followed the case in the papers without ever expecting to stand this close to any part of it. Desiree Okafor sat near the center of the room at a small easel, June’s decoy sketch — a haunting, technically precise rendering of Elias Marsh’s face that June had spent an entire afternoon perfecting specifically for this purpose — displayed on a covered stand beside her, waiting for the scheduled reveal.

June watched the feed from the security office two floors up, Nasser beside her, a bank of monitors showing every angle of the room from cameras the venue’s owner had agreed, after considerable persuasion, to have quietly supplemented for the evening.

“Anything?” Nasser asked, for perhaps the tenth time in twenty minutes.
...
On the monitor, the man in gray glanced toward the covered sketch, then toward the room’s exits, with the specific, calculating attention of someone measuring escape routes before committing to whatever he’d actually come to do.`,
  },
  {
    chapter: "Chapter 4 — The Decoy",
    text: `The reveal, when Roland finally stepped forward to remove the cloth from June’s decoy sketch, produced exactly the murmur of appreciation the event had been designed to generate — a genuinely striking piece of work, Marsh’s haunted expression rendered with enough technical mastery that several attendees raised phones to photograph it, unaware that the entire evening’s actual purpose had nothing to do with the drawing itself.

June watched the man in gray on the monitor, waiting for some reaction, some tell, and found instead that he had already begun moving — not toward the sketch, but toward Okafor herself, closing the distance with a directness that made every plainclothes officer in the room shift subtly, preparing to intercept.

“He’s not interested in the drawing,” Nasser said sharply. “He’s interested in her.”
...
“Simon Wexler,” Nasser said, and June realized, from the immediate recognition in the detective’s voice, that the name had already surfaced somewhere in their investigation without June having heard it directly. “You want to tell us about Delancey Street, or would you rather do that downtown.”
...
June considered the request for a long moment, thinking of Wexler’s words in the alley — I wanted someone like you to draw me the way you draw him — and understood, with sudden and complete clarity, exactly what her refusal needed to be.

“No,” she said. “I’m not drawing him. Not for the wire service, not for you, not for anyone. That’s the one thing he actually wanted from all of this, and I’m not giving it to him.”

Roland argued, briefly and without much real conviction, then let it go — the story, he conceded, would run just as well without an illustration of the man at its center, built instead on the drama of the confrontation itself and the quiet, unusual detail of a courtroom artist who had, for once, declined to draw the most obvious subject in the room.

June found, filing the story without an accompanying sketch, a small, unfamiliar satisfaction in the omission — the first genuine choice she’d made in the entire ordeal that belonged completely to her rather than to the case, the trial, or the man who had spent a week trying to claim her attention as though it were something owed to him.`,
  },
  {
    chapter: "Chapter 5 — Cracks in the Case",
...
The realization settled something in her chest she hadn’t fully known was still unsettled.

Afterward, in the courthouse hallway, Nasser caught up with her near the elevators. “Wexler’s attorney is already floating a plea deal,” she said. “Reduced sentence in exchange for full cooperation on the forensic discrepancies at Delancey Street, which will help close out Marsh’s case cleanly on appeal if it comes to that.”

“Do you think it will? Come to that?”

“I think Marsh’s attorney is already filing the paperwork,” Nasser said. “I think the amended charges from the two fires he actually committed will likely still convict him. I think justice, in this particular case, is going to end up looking less like a single clean verdict and more like two separate, imperfect ones sitting uncomfortably beside each other.” She studied June for a moment. “How are you doing, with all of it?”

June considered the question honestly, surprised to find she had an answer readily available rather than needing to search for one.

“Tired,” she said. “But not afraid anymore. I think that’s the part that matters most.”`,
  },
  {
...
She did not stop drawing courtroom sketches after the Marsh trial concluded — the work remained, whatever its risks, the thing she was genuinely good at, the thing that had sustained her career and, in its odd way, her sense of purpose for a decade — but she changed, quietly and without announcement, the way she signed her published work, dropping the small flourish she’d used for years beneath her signature specifically because it had become, she realized reading back through FRAME.WORTHY’s obsessive technical commentary, one of the identifying details he’d studied most closely.

It was a small adjustment. It felt, doing it, considerably larger than small.

Her editor never asked why the flourish disappeared. June never explained. Some choices, she had learned, did not require an audience to matter.`,
  },
  {
    chapter: "Chapter 6 — Alley",
...
“I read about what happened to you,” Kim said. “The stalking. The alley.”

“It worked out,” June said simply.

“It uncovered evidence that should have been part of this trial from the beginning,” Kim said. “Whatever else is true about my client, he didn’t deserve to be convicted for a fire someone else set out of jealousy and ambition. You’re the reason that didn’t happen. I wanted you to know I understand that, even though the verdict today doesn’t change much for him overall.”

June considered the strange, complicated shape of the compliment — thanks for the outcome of a case she’d never intended to influence, offered by an attorney whose client remained, by every meaningful measure, guilty of real and serious harm. It was not a clean feeling. Very little about the entire ordeal, she was beginning to understand, had ever offered a clean feeling.

“I didn’t do it for him,” she said honestly. “I did it because someone was stalking me, and stopping that felt like the only sane response available.”

“Sometimes the sane response and the right one happen to overlap,” Kim said. “I’ll take it, either way.”`,
  },
  {
    chapter: "Chapter 6 — Alley",
...
She thought, watching him, of his words in the alley. I wanted someone like you to draw me the way you draw him.

She had refused, and would continue refusing, and understood, sitting in that gallery for the last time, that the refusal itself had been the correct and complete answer — not a punishment exactly, though she suspected he might experience it as one, but simply the plain, unglamorous truth that some people did not deserve the specific, careful attention her work extended to everyone else who passed through a courtroom.

Nasser found her outside afterward, on the courthouse steps, in the thin autumn light that had replaced the summer heat of the trial’s opening weeks.

“Last one,” Nasser said. “At least for this case.”

“Last one,” June agreed.

“Any advice for the next artist who ends up covering something like this?”

June considered the question seriously, thinking of nine hundred faces, of a decade spent watching other people’s worst days without ever once expecting to become part of the story herself.

“Draw the truth,” she said finally, “and refuse to draw whoever’s only interested in being seen. Those aren’t always the same request, but you’ll know the difference when it matters.”`,
  },
  {
...
Nasser called occasionally, mostly to update her on the case’s slow procedural aftermath — Wexler’s appeal denied, Marsh’s own appeal proceeding through channels that would likely take years to resolve — and, less officially, simply to check in, a professional relationship that had, somewhere in the alley and the weeks following it, become something closer to an actual friendship.

“You did good work on this one,” Nasser told her, during one of these calls, months after the sentencing. “Better than the badge, some days.”

“I just refused to be afraid of my own sketchpad,” June said. “That’s not exactly heroic.”

“It’s more than most people manage,” Nasser said. “Take the compliment.”

June, after a moment, did.`,
  },
  {
    chapter: "Chapter 7 — Confession",
...
“Once,” June admitted. “After the sentencing. I wanted to see if I’d missed anything obvious, some warning sign that should have told me sooner what I was actually dealing with.”

“Did you find anything?”

June thought about the hundreds of admiring, technically detailed posts, the slow curdling of appreciation into obsession, the specific, unsettling moment three weeks before the alley when admiration had apparently tipped, in Wexler’s mind, into entitlement. “I found a lot of loneliness,” she said finally. “Dressed up as expertise. I don’t think that excuses anything he did. But I think it explains, a little, how someone gets from admiring a stranger’s work to believing that stranger owes him something for it.”

Nasser looked up from her paperwork at that, something thoughtful crossing her tired face. “That’s a more generous read than most people would offer a man who let an innocent stand trial for his own fire.”

“I’m not trying to be generous,” June said. “I’m trying to understand it well enough that I recognize it faster, if it ever happens again.”

“Will it?”

June considered the question seriously, thinking of nine hundred faces, of an entire profession built on rendering strangers’ worst moments with enough precision that occasionally, inevitably, someone would mistake that precision for an invitation.

“Maybe,” she said. “But I’ll know what to look for now. That has to count for something.”`,
  },
  {
    chapter: "Chapter 8 — Blank Peace",
    text: `The following autumn, a full year after the Marsh trial began, June accepted an assignment she would once have considered beneath her — a minor civil dispute, low stakes, no cameras banned because none had ever wanted to attend, the wire service sending her mostly out of habit rather than any real editorial need for illustration. She took the job anyway, drawn by the particular, unglamorous quiet of a courtroom where nothing about the outcome mattered enough to attract anyone’s obsessive attention.
...
She did not draw anything that evening. She had learned, finally, that peace sometimes required exactly that: a page left blank on purpose, holding nothing anyone else needed to see.`,
  },
  {
    chapter: "Chapter 8 — Blank Peace",
...
At home, she hung the watercolor in her kitchen, an unremarkable landscape in an unremarkable room, and returned to her studio to find her sketchpad exactly where she’d left it, open to the blank page she’d let sit untouched for a week.

She picked up her pencil at last, not because anyone needed the drawing, but because the page had waited long enough, and some part of her, finally, wanted to fill it.

She drew nothing dramatic. Just her own hands, steady now, exactly as they were.`,
  },
];
