...
/**
 * The Late Train — finished YAJ original adult romance novella.
...
Nora set her portfolio between her sensible shoes and calculated how late she could arrive at her mother's birthday dinner before concern hardened into biography.
...
"Don't," she said. "I am tired of people disappearing before anything is explained."`,
  ...
  {
    chapter: "Chapter 1 — Delay",
    text: `Every seat was taken except two facing each other in the final car, beneath a flickering light. Nora sat by the window. Julian lowered himself opposite her, leaving his coat on as if he might be asked to leave.
...
Julian rubbed his thumb over the book's cracked corner.
...
He returned from the café with black coffee for himself and tea with one sugar for her. He remembered. She resented that too.
...
For years she had created an answer sturdy enough to live with: he had been afraid, and she had mistaken affection for courage. That answer allowed her to marry someone dependable, divorce him kindly, and avoid the old garden station.
...
She laughed once. "We loved each other. We also made each other smaller in polite ways. Three years ago, he took a job in Copenhagen. I was relieved not to be asked along."

"I'm sorry."

"Don't be. We send birthday messages. His husband has excellent taste."

Nora stood, but the story had loosened the shape of her past. She had married David partly because he could never resemble Julian, then blamed the marriage for succeeding at exactly that.
...
She brought two almond pastries and claimed the bakery had packaged them incorrectly. They discussed his platform redesign and her work coaxing mold from an atlas.
...
He said, "I go to therapy on Tuesdays. I apologized to Mara without asking her to tell me I was good. None of that was for you."
...
They learned the outlines of each other's changed lives and avoided the word future with mutual professionalism.
...
At Bellwether, snow had begun. Julian offered to walk her to the yellow house. Nora agreed.
...
Over dinner, Nora heard the family's old hurt beneath every sharp joke. Julian had not merely left one bride. He had torn himself from a web of people who had made room for him.
...
But when she went inside, she watched through the curtain until he reached the corner, and Julian looked back once before he disappeared.`,
  ...
  {
    chapter: "Chapter 3 — Stations Between",
    text: `The museum's winter benefit arrived in February. Nora wore a black dress and spent the first hour steering champagne away from irreplaceable paper.
...
At the benefit, he listened while Nora explained iron-gall ink corrosion. He did not perform intimacy by telling old stories that belonged to a previous version of them.
...
Julian found a heritage railway that served dinner along the river. Nora accused him of making transit his entire personality.
...
Their laughter broke the tension they had carried since sitting down.
...
His apartment overlooked the tram depot. On the shelf beside his bed stood a wooden box.
...
They agreed to discuss it Sunday. On Saturday, a transformer fire shut Union Terminal and sent passengers into the streets.
...
She walked three miles through rain. At the barricade, Julian stood in an emergency blanket. When he saw her, he pushed through the crowd.
...
Nora sat alone. She could not build a life where every ordinary failure became proof of catastrophe.
...
They stayed there until the sirens faded, accepting that love could accompany repair without claiming to be the repair itself.`,
  },
  {
    chapter: "Chapter 5 — Signal Failure",
    text: `Sunday's Lisbon conversation took place at Elise's kitchen table.
...
Elise descended immediately with plates. Under the table, Julian's knee touched Nora's. Their plan contained no guarantees. For the first time, uncertainty felt less like an ambush than a country they might learn to cross.`,
  },
  {
    chapter: "Chapter 6 — The Honest Timetable",
    text: `Nora received the Lisbon fellowship on a Wednesday in April. Julian's firm approved the rotation plan the same afternoon.
...
The weeks before departure filled with practical questions. Beneath each lay a larger one: what were they to each other now?
...
They made love among cardboard boxes while trains sounded beyond the river. Nora no longer mistook the absence of a grand promise for the absence of devotion. Sometimes devotion was a date returned to, ordinary and exact.`,
  ...
  {
    chapter: "Chapter 6 — The Honest Timetable",
    text: `Lisbon smelled of hot stone, coffee, and the Atlantic. Nora's archive occupied a former convent.

She and Julian rented a narrow apartment and built a domestic life in miniature. He surveyed sites; she unfolded damp maps. At night they learned the city's hills.
...
The first week was difficult. Their calls misfired. Nora missed two messages while out with colleagues and refused to feel guilty for enjoying the night.
...
She kissed him while taxis streamed around them, grateful for the difference between counting minutes in fear and counting them because someone had told you when to expect his face.`,
  ...
  {
    chapter: "Chapter 6 — The Honest Timetable",
    text: `In July, Julian's sister Sofia called. Elise had collapsed and was in the hospital with an irregular heartbeat.
...
At the gate, a storm canceled their flight.
...
Julian found seats on a morning flight. When they reached Bellwether, Elise was sitting up, criticizing the oatmeal.
...
On the final night of service, Julian had to inspect the closure, and Nora joined him.

They boarded the last car, where their second chance had begun.
...
Nora rested against him. She had thought returning would require recovering the people they had been. Instead old love became a language through which two altered adults learned to speak.
...
"It is a request for floor plans."`,
  ...
  {
    chapter: "Chapter 7 — Last Service",
    text: `They found an apartment above a closed music shop, with tall windows, crooked floors, and two small studios.
...
Nora touched his wrist. Conservation did not erase damage. It stabilized what remained and made future handling possible.
...
She went alone on the final public afternoon. Frost silvered the pergola.
...
Nora felt grief for what happened and for the possible life that never existed. It did not accuse her present happiness. It asked to be included.
...
After speeches, Elise produced a picnic from an enormous bag.
...
The animal was small, mud-colored, and spectacularly undignified.
...
Forty-eight hours became a week, then adoption. Kevin feared the vacuum, adored Elise, and ate the corner of a transit proposal.
...
The honesty steadied them more than certainty could have. When the platform number appeared, they walked toward it with Kevin tugging ahead, eager for every destination and entirely uninterested in the history of trains.`,
  ...
  {
    chapter: "Chapter 8 — Arrival",
    text: `The coastal train reached the sea near dusk.
...
At the seaside terminus, rain had begun. Julian lifted the reluctant dog. Nora carried the bags. They walked toward the hotel laughing.
