    ...
    steps: [
      ...
      },
      {
        ...
        lines: [
          ...
          "Slowly tilt your head toward your left shoulder.",
      ...
      },
      {
        ...
        lines: [
          ...
          "Reach both arms slowly overhead.",
          "Inhale as you lift. Feel length through your sides.",
      ...
      },
      {
        ...
        lines: [
          "Hinge gently from your hips — never rush.",
          "Soft knees are perfect. Let your head hang heavy.",
          "Exhale and fold only as far as feels easy.",
