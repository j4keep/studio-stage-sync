...
const GlobalPlaylistPlayer = () => {
  const {
    ...
    skipPlaylistTrack, stopPlaylistPlayback,
  } = usePlaylists();
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="flex items-center gap-3 p-2.5 rounded-xl bg-card/95 backdrop-blur-xl border border-border shadow-lg">
