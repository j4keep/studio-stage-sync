  ...
  return (
    <>
      <div className="absolute inset-0 bg-black">
        ...
        <div className="absolute right-3 bottom-36 z-40 flex flex-col items-center gap-5">
        ...
        <button onClick={() => navigate(`/artist/${post.user_id}`)} className="absolute right-3 bottom-20 z-50 relative">
