      ...
      >
        {book.coverImage ? (
          ...
          <>
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/55 to-transparent p-2.5 pt-8">
              <p className={`font-bold leading-tight text-white line-clamp-2 ${kids ? "text-sm" : "text-xs"}`}>
                {book.title}
              </p>
            </div>
          </>
