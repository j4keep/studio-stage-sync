...
export default function MoveInstructionCard({
  ...
  return (
    <div className="relative mx-auto flex w-full max-w-[340px] flex-col overflow-hidden rounded-[1.6rem] border border-stone-200 bg-white shadow-[0_20px_50px_-28px_rgba(15,80,70,0.45)]">
      ...
      <div className="relative mx-auto my-1 flex aspect-square w-[90%] max-w-[300px] items-center justify-center rounded-2xl bg-gradient-to-b from-[#eef6f3] via-[#f5faf8] to-[#e8f2ef]">
        <YajWellnessAvatar
          move={illustration}
          figure={figure}
          skinTone={skinTone}
