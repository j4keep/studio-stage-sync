  ...
  return (
    <div className="px-4 pt-6 pb-24 max-w-2xl mx-auto">
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        <section>
          <p className="italic">
            Atchup is a unified platform that combines the creator app (Feed, TV, music, projects, store) and the <strong className="text-foreground">Catch Up Circle</strong> (community savings rotations & fundraisers). One account, one set of terms — these apply across the entire platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            By accessing or using Atchup ("App"), you agree to be bound by these Terms of Use and Privacy Policy. If you do not agree, you may not use the App.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            One Atchup account works across the platform — Feed, TV, Circle, and creator tools. There is no separate Circle login or profile picture. Your display name, avatar, and credentials are shared across all features.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Atchup is not a bank or licensed money transmitter. We provide tooling to coordinate community savings; funds are held and moved by our payment processor (Stripe).</li>
        ...
        <section>
          ...
          <p>
            Creators must upload only original or properly licensed content (audio, video, podcasts, short films, music videos). No external copyrighted music is allowed on Radio. Creators retain ownership of their content and grant Atchup a non-exclusive license to display, stream, and promote it within the App.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            Creator payouts are handled via Stripe Connect. Atchup is not responsible for payment disputes outside of the platform's dispute resolution process.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Atchup may suspend or permanently deactivate accounts for any violation of these Terms, fraudulent activity, or repeated abuse. Deactivated accounts are permanent and associated data may be deleted after 90 days, subject to legal retention requirements.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Atchup provides the platform "as is" with no warranties regarding uptime, content accuracy, or transaction outcomes. We are not liable for losses arising from use of the App.
          </p>
        </section>
        ...
        <section id="privacy">
          ...
          <p>
            Atchup collects and processes personal data necessary to provide platform services, including account information, uploaded content metadata, Circle membership and contribution records, payment information, and usage analytics.
          </p>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>Personal information is used solely for providing platform services and is never sold to third parties.</li>
            <li>Payment data is processed securely through Stripe and is not stored on Atchup servers.</li>
            ...
            <li>Atchup may share data with law enforcement when required by law or to prevent fraud.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            By using Atchup, you acknowledge that you have read, understood, and agree to these Terms of Use and Privacy Policy.
          </p>
        </section>
      </div>
    </div>
