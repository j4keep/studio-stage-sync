...
import FeedRoutePage from "./pages/FeedRoutePage";
import ExploreRoutePage from "./pages/ExploreRoutePage";
  ...
  return (
    ...
    <AppLayout>
      <Routes>
        ...
        <Route path="/explore" element={<ExploreRoutePage />} />
        ...
        <Route path="/feed" element={<BreakGuard><FeedRoutePage /></BreakGuard>} />
